...
Full code is available here: [More_complex_example](https://github.com/sichkar-valentyn/Neural_Networks_for_Computer_Vision/blob/master/Codes/More_complex_example.py)
