...
from Digits_Classification.Helper_Functions.layers import *
...
class ConvNet1(object):
    ...
    def loss_for_training(self, x, y):
        ...
        cnn_output, cache_cnn = cnn_forward_strides(x, w1, b1, self.cnn_params)
        ...
        pooling_output, cache_pooling = max_pool_forward_fast(relu_output_1, self.pooling_params)
        ...
        d_pooling = max_pool_backward_fast(dx2, cache_pooling)
        d_relu_1 = relu_backward(d_pooling, cache_relu_1)
        # dx1, dw1, db1 = cnn_backward_naive(d_relu_1, cache_cnn)
        dx1, dw1, db1 = cnn_backward_strides(d_relu_1, cache_cnn)
        # Adding L2 regularization
    ...
    def scores_for_predicting(self, x):
        ...
        cnn_output, _ = cnn_forward_strides(x, w1, b1, self.cnn_params)
        relu_output_1, _ = relu_forward(cnn_output)
        # pooling_output, _ = max_pooling_forward_naive(relu_output_1, self.pooling_params)
        pooling_output, _ = max_pool_forward_fast(relu_output_1, self.pooling_params)
